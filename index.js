window.addEventListener('load', async () => {
    ...
    const endPoint = window.innerWidth < 768 ? 100 : 180; // ternary
    const endScale = window.innerWidth < 768 ? 4 : 6; // ternary
    const opacityTransLength = window.innerWidth < 768 ? 80 : 120; // ternary
