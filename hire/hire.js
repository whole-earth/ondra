...
async function initialize() {
  ...
  // Call the async functions to wait for the event listeners to complete
  const [peaceCompleted, cdjCompleted] = await Promise.all([
    peaceDOMContentLoadedListener(),
    cdjDOMContentLoadedListener()
  ]);
